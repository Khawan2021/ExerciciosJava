...
public class ExemploComparations {
    public static void main(String[] args) {
        ...
        System.out.println("--- ordem natural dos números - idade (metho refence)");
        System.out.println(estudantes);

        estudantes.sort(Comparator.comparingInt(Estudante::getIdade).reversed());

        System.out.println("--- ordem reversa dos números - idade (metho refence)");
        System.out.println(estudantes);
